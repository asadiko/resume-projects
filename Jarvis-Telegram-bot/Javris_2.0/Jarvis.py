...
def start(update, context):
    update.message.reply_text("Hello! My name is Jarvis and I am the AI model developed by Asado. I can answer to all your questions and answer to almost all your questions.)")


def help(update, context):
    update.message.reply_text("""
    The Following commands are available:
    /start -> Welcome to Jarvis
    /help ->This Message
    /about -> About Jarvis
...
def about(update, context):
    update.message.reply_text("""
            Jarvis is not just a chatbot. It's so much more than that. It's an AI-enabled customer service solution that answers your questions, responds to your tweets, and helps you find the products you're looking for. Jarvis has the power to save you time, increase your sales, and make your customer service operation more efficient.
        """)


def contact(update, context):
    update.message.reply_text(
        "Developer: Asadulla Ravshanbekov \n email: asadullaravshanbekov04@gmail.com\n")
